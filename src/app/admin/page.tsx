        ...
        <div className="p-6">
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <p className="text-sm text-gray-600">New user registered: john.doe@example.com</p>
              <span className="text-xs text-gray-400">2 minutes ago</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              <p className="text-sm text-gray-600">Script "data_processor.py" completed successfully</p>
            ...
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <p className="text-sm text-gray-600">New script uploaded: "analytics_tool.js"</p>
